...
% \setlist[enumerate]{noitemsep,topsep=4pt,label=\arabic*.}
  ...
  they contributed to. It is acceptable for all members to contribute to
  all points. \emph{For full marks, all numbered points should be
    addressed.}

  The project should be completed as a written report, including a
  type-set \verb|pdf| file. The coding component should be runnable. It is
